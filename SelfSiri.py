...
zz7 = LINETCR.LINE()
#zz7.login(qr=True)
zz7.login(token='Ev3VuzPvB2c7TEIDrXra.gIHgalwJsMTFisMR+xM0wG.RYQcXjh7TSoDX92TQZU7QxE0MqgQzRWeiRrTZkeQdZM=')
zz7.loginResult()
...
╰━━━━━━━━━━━━━━━╯
"""
combat="u1a284600b5a34a6b5f2129abfd79b45a"
        ...
        if op.type == 5:
           if wait["autoAdd"] == True:
              ...
              if(wait["message"]in[""," ","\n",None]):
                ...
                zz7.sendText(op.param1,str(wait["message"]))
                ...
                try:
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            Np = zz7.getContact(op.param2).pictureStatus
#                            Name = summon(op.param2)
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        zz7.sendText(op.param1, "Halo " + "☸ " + Name + " ☸")
                                        zz7.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net/" + Np)
                                        time.sleep(0.2)
                                        summon(op.param1)
                                    else:
                                        zz7.sendText(op.param1, "Halo " + "☸ " + Name + " ☸")
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            zz7.sendText(op.param1,"Hallo " + zz7.getContact(op.param2).displayName + "\nWelcome To ☸ " + str(ginfo.name) + " ☸" + "\nBiasakan Cek Note\nSupaya Kagak Nyasar Disini\nDan Semoga Betah Disini ^_^")
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                  ...
                                  msg.contentMetadata = {
                                                       ...
                                                       "STKPKGID": "1582380",
                                                       "STKVER": "1" }
                                  zz7.sendMessage(msg.to,"Mohon maaf lahir batin ya kak...😄 \nbot sering nyumpahin kk" )                                
                                  break
        ...
        if op.type == 25:
            ...
            if msg.text in ["Bot on"]:
                wait["Bot"] = True
                zz7.sendText(msg.to,"Bot Sudah On Kembali.")  
        ...
        if op.type == 25:
          if wait["Bot"] == True:    
			...
			zz7.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': combat}
                zz7.sendMessage(msg)
		...
		zz7.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            if msg.contentType == 13:
                ...
                zz7.sendText(msg.to,menuMessage)
                ...
                zz7.sendText(msg.to,siriMessage)
		...
		if msg.from_ in admin:
		    ...
		    zz7.sendText(msg.to, "Khusus zz7")
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = zz7.getGroup(i).name
		        if h == ng:
			    zz7.sendText(i,"Bot Di Paksa Keluar Oleh Owner!")
		            zz7.leaveGroup(i)
		...
		if msg.from_ in admin:
                    ...
                    zz7.sendText(msg.to,"Auto Respon1 Sudah Aktif")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")
		...
		if msg.from_ in admin:
                    ...
                    zz7.sendText(msg.to,"Auto Respon1 Sudah Off")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")	
		...
		if msg.from_ in admin:
                    ...
                    wait["detectMention3"] = False
                    wait["kickMention"] = False
                    zz7.sendText(msg.to,"Auto Respon2 Sudah Aktif")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")
            elif msg.text in ["Respon2 off"]:
		if msg.from_ in admin:
                    wait["detectMention2"] = False
                    zz7.sendText(msg.to,"Auto Respon2 Sudah Off")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")	
		...
		if msg.from_ in admin:
                    ...
                    wait["kickMention"] = False
                    zz7.sendText(msg.to,"Auto Respon3 Sudah Aktif")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")
		...
		if msg.from_ in admin:
                    wait["detectMention3"] = False
                    zz7.sendText(msg.to,"Auto Respon3 Sudah Off")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")	
		...
		if msg.from_ in admin:
                    ...
                    wait["detectMention2"] = False
                    wait["detectMention3"] = False                    
                    zz7.sendText(msg.to,"Auto Respon Kick Sudah Aktif")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")
		...
		if msg.from_ in admin:
                    wait["kickMention"] = False                    
                    zz7.sendText(msg.to,"Auto Respon Kick Sudah Off")
		else:
		    zz7.sendText(msg.to,"Khusus zz7")			  
		...
		if msg.from_ in admin:
		    ...
		    zz7.sendText(msg.to,"Khusus zz7")
                ...
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        zz7.sendText(msg.to,"Sambutan Di Aktifkanヾ(*´∀｀*)ﾉ")
                else:
                    wait["Sambutan"] = True
                    if wait["lang"] == "JP":
                ...
                if wait["Sambutan"] == False:
                    if wait["lang"] == "JP":
                        zz7.sendText(msg.to,"Sambutan Di Nonaktifkan(　＾∇＾)")
                else:
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
                ...
                wait["Sider"] = True
                zz7.sendText(msg.to,"Siap On Cek Sider")
                ...
                if msg.to in cctv['point']:
                    ...
                    zz7.sendText(msg.to, "Heh Belom Di Set")                         
		...
		if msg.from_ in admin:	 	        
		    ...
		    zz7.sendText(msg.to,"Success Add all")
                ...
                wait["likeOn"] = True
                zz7.sendText(msg.to,"Shere Post Kamu Yang Mau Di Like!")                
		...
		if msg.from_ in Creator:
		    zz7.sendText(msg.to, "Bot Has Been Restarted...")
		    restart_program()
		    print "@Restart"
		else:
